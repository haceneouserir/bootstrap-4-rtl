...
// create the zip file
const deleteCommand = `PowerShell Remove-Item -Path ${distFolder}.zip`
const buildCommand = `PowerShell Compress-Archive -Path "${distFolder}" -CompressionLevel Optimal -DestinationPath ${distFolder}.zip`
